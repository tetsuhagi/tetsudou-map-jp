...
自動執筆ルーチンは、このリストの **未チェック（`- [ ]`）の最上位** から1件取って執筆する。
並び順は 路線:コラム ≒ 2:1 になるよう事前ミックス済み。

**運営者はいつでも並び替え・追加・削除してOK**（上にあるものほど早く公開される）。
書き終えたらルーチンが `- [x]` にして `→ 公開日 / slug` を追記する。
重複等でスキップした行は `[skip: 理由]` を付けて残す。
...
- [x] 【コラム】飛騨高山へのアクセス: 特急ひだの旅が観光の一部になる理由 — slug案: takayama-access → 2026-07-24 / takayama-access
...
- [x] 【路線】はやぶさ・こまち（東京〜新青森・秋田）— slug案: hayabusa-komachi → 2026-08-16 / hayabusa-komachi
- [x] 【コラム】北陸新幹線で行く金沢・富山の旅: かがやき・つるぎの使い分け — slug案: hokuriku-shinkansen-tabi → 2026-08-17 / hokuriku-shinkansen-tabi
- [x] 【路線】みずほ・さくら（新大阪〜鹿児島中央）九州新幹線 — slug案: mizuho-sakura → 2026-08-18 / mizuho-sakura
...
- [ ] 【路線】むろと（徳島〜阿波海南）牟岐線 — slug案: muroto [skip: 特急むろとは2025-03-15ダイヤ改正で廃止（徳島〜牟岐で運行終了・牟岐線から特急消滅）。運行中前提の路線ガイドは執筆不可。廃止列車の扱い（さよなら/振り返り記事にするか、取り下げるか）は運営者判断待ち]
- [x] 【コラム】四国西南部・幡多地方への旅: 四万十川と足摺岬を鉄道で目指す — slug案: hata-chiho-tabi → 2026-09-05 / hata-chiho-tabi
...
- [x] 【路線】びわこエクスプレス（大阪〜米原・草津）JR西の通勤特急 — slug案: biwako-express → 2026-09-24 / rakuraku-biwako ［注: 2024-03-16のダイヤ改正で列車名が「らくラクびわこ」に改称済みのため、現行名に合わせてスラッグを rakuraku-biwako に変更。記事内では旧名「びわこエクスプレス」も title・description・本文で併記］
- [ ] 【路線】いさぶろう・しんぺい／かわせみ やませみ（熊本〜人吉方面）— slug案: isaburo-shimpei [skip: 2026-09-25確認。肥薩線は八代〜人吉が2020年7月豪雨で被災したままで、復旧目標は2033年度（2024年に熊本県とJR九州が基本合意）。人吉〜吉松も運休が続き、「いさぶろう・しんぺい」は熊本〜人吉方面では運行していない。「かわせみ やませみ」は豊肥本線の熊本〜宮地へ移り、臨時の特急として季節運転中。バックログ記載の区間前提では路線ガイドを書けないため見送り。「豊肥本線のかわせみ やませみ」として書き直すか、肥薩線の振り返り記事にするかは運営者判断待ち]
- [x] 【路線】フルーティアふくしま後継・observation系など東北の観光列車 — slug案: tohoku-kanko-ressha → 2026-09-25 / tohoku-kanko-ressha ［注: 2026-09時点で現行運行の6本（リゾートしらかみ／TOHOKU EMOTION／ひなび（陽旅）／SATONO／POKÉMON with YOU トレイン／びゅうコースター風っこ）に絞って構成。フルーティアふくしまは2023-12で運行終了、後継の位置づけとして2024-04運行開始のSATONOを紹介する形にした］
- [x] 【コラム】観光列車の食事つきプランはアリか？きっぷ単体との違いと選び方 — slug案: kanko-ressha-dining → 2026-09-26 / kanko-ressha-dining
...
最終更新: 2026-09-26（コラム 観光列車の食事つきプラン公開。未チェックは skip 注記の2件を除き7件）
